...
#this model is created with sea ice concentration statistics as features and ice extent as ground truth,
#not sure where the code went for this, but its easy to train
