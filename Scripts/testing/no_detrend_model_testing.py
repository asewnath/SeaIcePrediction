# -*- coding: utf-8 -*-
"""
Created on Thu Jun 28 15:22:49 2018

@author: Akira
"""

#The script will be to test models with data that has not been detrended
...
for i in range(10):
    ...
    X_train, X_test, y_train, y_test = train_test_split(predVarTrain, extentTrain, test_size=0.3, random_state=None) #cross validation going on here
    
    regr = RandomForestRegressor(verbose=0, n_estimators=30, bootstrap=True, criterion="mse", max_features=3,
