...
imageSize = 21
numForecast = 6
numChannels = numForecast+3 #accounting for the region mask and thickness
resolution = 100
batchSize = 400
regBool = 1
...
for year in range(startYear, stopYear+1):
    ...
    for index in range(0, 12):
        ...
        data, groundTruth, size = create_input_thickness(months[index], year, numForecast, imageSize, resolution, regBool)
